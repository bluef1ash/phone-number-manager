...
public class DatabaseInitializeRunner implements CommandLineRunner {
    ...
    private void configurationDataInitialize() {
        if (configurationService.list() == null) {
            ...
            configurations.add((Configuration)new Configuration().setKey("system_administrator_id")
                ...
                .setDescription("系统管理员编号").setKeyIsChanged(false).setCreateTime(date).setUpdateTime(date));
            ...
            configurations.add((Configuration)new Configuration().setKey("excel_resident_title_up")
                ...
                .setKeyIsChanged(false).setCreateTime(date).setUpdateTime(date));
            ...
            configurations.add((Configuration)new Configuration().setKey("excel_dormitory_title")
                ...
                .setDescription("楼长Excel表标题").setKeyIsChanged(false).setCreateTime(date).setUpdateTime(date));
    ...
    private void privilegeDataInitialize() {
        if (userPrivilegeService.list() == null) {
            ...
            userPrivileges.add((UserPrivilege)new UserPrivilege().setId(indexId).setName("首页相关")
                .setDescription("indexController").setParentId(topId).setCreateTime(date).setUpdateTime(date));
            userPrivileges.add((UserPrivilege)new UserPrivilege().setId(communityResidentTopId).setName("社区居民相关")
                .setDescription("communityResidentTitle").setParentId(topId).setIsDisplay(true).setCreateTime(date)
                .setUpdateTime(date));
            userPrivileges.add((UserPrivilege)new UserPrivilege().setId(communityTopId).setName("社区相关")
                .setDescription("communityTitle").setParentId(topId).setIsDisplay(true).setCreateTime(date)
                .setUpdateTime(date));
            userPrivileges.add((UserPrivilege)new UserPrivilege().setId(subdistrictTopId).setName("街道相关")
                .setDescription("subdistrictTitle").setParentId(topId).setIsDisplay(true).setCreateTime(date)
                .setUpdateTime(date));
            userPrivileges
                .add((UserPrivilege)new UserPrivilege().setId(systemTopId).setName("系统相关").setDescription("systemTitle")
                    .setParentId(topId).setIsDisplay(true).setCreateTime(date).setUpdateTime(date));
            userPrivileges.add((UserPrivilege)new UserPrivilege().setId(communityResidentManagerId).setName("社区居民管理")
                ...
                .setIconName("fa fa-phone").setIsDisplay(true).setCreateTime(date).setUpdateTime(date));
            userPrivileges.add((UserPrivilege)new UserPrivilege().setId(dormitoryManagerManagerId).setName("社区楼长管理")
                ...
                .setIconName("fa fa-university").setIsDisplay(true).setCreateTime(date).setUpdateTime(date));
            userPrivileges.add((UserPrivilege)new UserPrivilege().setId(communityManagerId).setName("社区管理")
                ...
                .setIsDisplay(true).setCreateTime(date).setUpdateTime(date));
            ...
            userPrivileges.add((UserPrivilege)new UserPrivilege().setName("获取首页菜单栏内容").setDescription("getMenu")
                .setUri("/getmenu").setParentId(communityResidentTopId).setIconName("fa fa-list").setCreateTime(date)
                .setUpdateTime(date));
            ...
            userPrivileges.add((UserPrivilege)new UserPrivilege().setName("居民电话列表")
                ...
                .setIconName("fa fa-list").setIsDisplay(true).setCreateTime(date).setUpdateTime(date));
            userPrivileges
            ...
            userPrivileges
                .add((UserPrivilege)new UserPrivilege().setName("修改居民信息").setDescription("editCommunityResident")
                    ...
                    .setIconName("fa fa-pencil-square-o").setCreateTime(date).setUpdateTime(date));
            userPrivileges.add((UserPrivilege)new UserPrivilege().setName("添加、修改居民信息处理")
                ...
                .setParentId(communityResidentManagerId).setCreateTime(date).setUpdateTime(date));
            ...
            userPrivileges.add((UserPrivilege)new UserPrivilege().setName("使用AJAX技术加载社区居民列表")
                ...
                .setParentId(communityResidentManagerId).setIconName("fa fa-list").setCreateTime(date)
                .setUpdateTime(date));
            ...
            userPrivileges.add((UserPrivilege)new UserPrivilege().setName("添加、修改楼长信息处理")
                ...
                .setParentId(dormitoryManagerManagerId).setCreateTime(date).setUpdateTime(date));
            ...
            userPrivileges.add((UserPrivilege)new UserPrivilege().setName("修改社区信息").setDescription("editCommunity")
                ...
                .setCreateTime(date).setUpdateTime(date));
            userPrivileges.add(
                (UserPrivilege)new UserPrivilege().setName("添加、修改社区信息处理").setDescription("communityCreateOrEditHandle")
                    .setUri("/community").setParentId(communityManagerId).setCreateTime(date).setUpdateTime(date));
            userPrivileges.add(
                (UserPrivilege)new UserPrivilege().setName("通过AJAX技术删除社区信息").setDescription("deleteCommunityForAjax")
                    .setUri("/community").setParentId(communityManagerId).setCreateTime(date).setUpdateTime(date));
            ...
            userPrivileges.add((UserPrivilege)new UserPrivilege().setName("更改社区是否允许更删改信息")
                ...
                .setParentId(communityManagerId).setCreateTime(date).setUpdateTime(date));
            ...
            userPrivileges.add((UserPrivilege)new UserPrivilege().setName("添加、修改街道信息处理")
                ...
                .setParentId(subdistrictManagerId).setCreateTime(date).setUpdateTime(date));
            userPrivileges.add(
                (UserPrivilege)new UserPrivilege().setName("通过AJAX技术删除街道信息").setDescription("deleteSubdistrictForAjax")
                    .setUri("/subdistrict").setParentId(subdistrictManagerId).setCreateTime(date).setUpdateTime(date));
            ...
            userPrivileges.add((UserPrivilege)new UserPrivilege().setName("系统用户锁定与解锁")
                ...
                .setParentId(userManagerId).setCreateTime(date).setUpdateTime(date));
            ...
            userPrivileges.add((UserPrivilege)new UserPrivilege().setName("通过AJAX技术删除系统用户")
                ...
                .setCreateTime(date).setUpdateTime(date));
            userPrivileges.add((UserPrivilege)new UserPrivilege().setName("使用Ajax技术获取所有系统用户")
                .setDescription("getSystemUsersForAjax").setUri("/system/user_role/user/load")
                .setParentId(userManagerId).setIconName("fa fa-list").setCreateTime(date).setUpdateTime(date));
            userPrivileges.add((UserPrivilege)new UserPrivilege().setName("系统用户角色列表")
                ...
                .setIconName("fa fa-list").setIsDisplay(true).setCreateTime(date).setUpdateTime(date));
            userPrivileges.add((UserPrivilege)new UserPrivilege().setName("添加系统用户角色")
                .setDescription("createSystemUserRole").setUri("/system/user_role/role/create")
                .setParentId(userManagerId).setIconName("fa fa-plus").setCreateTime(date).setUpdateTime(date));
            ...
            userPrivileges
                .add((UserPrivilege)new UserPrivilege().setName("系统用户权限列表").setDescription("systemUserPrivilegeList")
                    ...
                    .setIsDisplay(true).setCreateTime(date).setUpdateTime(date));
            userPrivileges.add((UserPrivilege)new UserPrivilege().setName("添加系统用户权限")
                .setDescription("createSystemUserPrivilege").setUri("/system/user_role/privilege/create")
                .setParentId(userManagerId).setIconName("fa fa-plus").setCreateTime(date).setUpdateTime(date));
            userPrivileges
            ...
            userPrivileges.add((UserPrivilege)new UserPrivilege().setName("系统配置列表")
                ...
                .setIconName("fa fa-list").setIsDisplay(true).setCreateTime(date).setUpdateTime(date));
            userPrivileges.add((UserPrivilege)new UserPrivilege().setName("添加系统配置")
                .setDescription("createConfiguration").setUri("/system/configuration/create")
                .setParentId(systemManagerId).setIconName("fa fa-plus").setCreateTime(date).setUpdateTime(date));
            ...
            userPrivileges.add((UserPrivilege)new UserPrivilege().setName("添加与修改处理系统配置")
                ...
                .setParentId(systemManagerId).setCreateTime(date).setUpdateTime(date));
    ...
    private void systemUerAndRoleDataInitialize() {
        if (systemUserService.list() == null) {
            SystemUser systemUser = new SystemUser();
            Date expireTime = new Date(Long.MAX_VALUE);
            systemUser.setUsername("admin").setPassword(new BCryptPasswordEncoder().encode("admin888"))
                .setAccountExpireTime(expireTime).setCredentialExpireTime(expireTime).setCreateTime(date)
                .setUpdateTime(date);
            systemUserService.save(systemUser);
            administratorId = systemUser.getId();
        }
        UserRole systemUserRole = new UserRole();
        if (userRoleService.list() == null) {
            List<UserRole> userRoles = new ArrayList<>();
            systemUserRole.setName("ROLE_system").setDescription("系统管理员").setParentId(0L).setCreateTime(date)
                .setUpdateTime(date);
        ...
        if (systemUserRoleService.list() == null) {
            systemUserRoleService.save((UserRoleRelation)new UserRoleRelation().setUserId(administratorId)
                .setRoleId(systemUserRole.getId()).setCreateTime(date).setUpdateTime(date));
        }
    }
}
