...
public class CommunityController extends BaseController {
    ...
    public Map<String, Object> communityList(@ApiParam(name = "分页页码") Integer page, @ApiParam(name = "每页数据条数") Integer limit) {
    ...
    public Map<String, Object> communityCreateOrEditHandle(HttpServletRequest request, @ApiParam(name = "社区对象", required = true) @RequestBody @Validated Community community, BindingResult bindingResult) {
    ...
    public Map<String, Object> getCommunitiesBySubdistrictId(@ApiParam(name = "街道编号", required = true) @PathVariable(required = false) Long subdistrictId) {
        Map<String, Object> jsonMap = new HashMap<>(3);
        getRoleId();
    ...
    public Map<String, Object> chooseSubmitForAjax(@ApiParam(name = "用户加密数据", required = true) @RequestParam String data, @ApiParam(name = "更改类型", required = true) @RequestParam Integer changeType) {
        Map<String, Object> jsonMap = new HashMap<>(3);
    ...
    public Map<String, Object> subcontractorList(@ApiParam(name = "分页页码") Integer page, @ApiParam(name = "每页数据条数") Integer limit) {
        getRoleId();
        Map<String, Object> jsonMap = new HashMap<>(1);
        if (page == null) {
            jsonMap.put("subcontractors", subcontractorService.get(systemUser.getLevel(), systemUser.getCompanyId(), systemCompanyType, communityCompanyType, subdistrictCompanyType));
        } else {
            jsonMap.put("subcontractors", subcontractorService.get(page, limit, systemUser.getLevel(), systemUser.getCompanyId(), systemCompanyType, communityCompanyType, subdistrictCompanyType));
        }
        return jsonMap;
    }
    ...
    public Map<String, Object> getSubcontractorById(@ApiParam(name = "社区分包人编号", required = true) @PathVariable Long id) {
        getRoleId();
    ...
    public Map<String, Object> subcontractorCreateOrEditHandle(HttpServletRequest request, @ApiParam(name = "社区分包人对象", required = true) @RequestBody @Validated Subcontractor subcontractor, BindingResult bindingResult) {
        Map<String, Object> jsonMap = new HashMap<>(1);
        if (bindingResult.hasErrors()) {
            getRoleId();
            // 输出错误信息
    ...
    public Map<String, Object> loadSubcontractor(@ApiParam(name = "社区编号", required = true) @PathVariable Long communityId) {
        Map<String, Object> jsonMap = new HashMap<>(2);
