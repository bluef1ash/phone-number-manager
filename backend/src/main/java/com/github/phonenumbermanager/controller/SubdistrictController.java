...
public class SubdistrictController extends BaseController {
    ...
    @GetMapping
    @ApiOperation("街道列表")
    public IPage<Subdistrict> subdistrictList(@ApiParam(name = "分页页码") Integer page, @ApiParam(name = "每页数据") Integer limit) {
    ...
    public Map<String, Object> subdistrictCreateOrEditHandle(HttpServletRequest request, @ApiParam(name = "街道对象", required = true) @RequestBody @Validated Subdistrict subdistrict, BindingResult bindingResult) {
