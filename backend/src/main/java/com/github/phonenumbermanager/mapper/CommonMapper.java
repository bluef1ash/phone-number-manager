...
public interface CommonMapper<T> extends BaseMapper<T> {
     ...
     * @throws DataAccessException 数据库操作异常
     */
    List<T> selectAndCommunityByCommunityIds(List<Serializable> communityIds, PhoneNumberSourceTypeEnum phoneNumberSourceTypeEnum) throws DataAccessException;
     ...
     * @throws DataAccessException 数据库操作异常
     */
    IPage<T> selectAndCommunityByCommunityIds(Page<T> page, List<Serializable> communityIds, PhoneNumberSourceTypeEnum phoneNumberSourceTypeEnum) throws DataAccessException;
     ...
     * @throws DataAccessException 数据库操作异常
     */
    IPage<T> selectByUserRole(Page<T> page, @Param("companyType") Serializable companyType, @Param("companyId") Serializable companyId, @Param("systemCompanyType") Serializable systemCompanyType, @Param("communityCompanyType") Serializable communityCompanyType, @Param("subdistrictCompanyType") Serializable subdistrictCompanyType, @Param("object") T object) throws DataAccessException;
     ...
     * @throws DataAccessException 数据库操作异常
     */
    List<T> selectByPhones(List<PhoneNumber> phoneNumbers, Serializable id, Serializable subdistrictId, PhoneNumberSourceTypeEnum sourceType) throws DataAccessException;
