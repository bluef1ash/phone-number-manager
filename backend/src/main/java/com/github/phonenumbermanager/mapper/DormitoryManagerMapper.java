...
public interface DormitoryManagerMapper extends BaseMapper<DormitoryManager> {
     ...
     *             数据库连接异常
     */
    LinkedHashMap<String, Long> countPoliticalStatusRangeCommunityId(Serializable communityId)
        throws DataAccessException;
     ...
     *             数据库连接异常
     */
    LinkedHashMap<String, Long> countPoliticalStatusRangeSubdistrictId(Serializable subdistricId)
        throws DataAccessException;
     ...
     *             数据库操作异常
     */
    LinkedList<Map<String, Object>> sumManagerCountForGroupByCommunityId(Serializable subdistrictId)
        throws DataAccessException;
     ...
     *             数据库操作异常
     */
    LinkedList<Map<String, Object>> sumManagerCountForGroupCommunity(Serializable communityId)
        throws DataAccessException;
}
