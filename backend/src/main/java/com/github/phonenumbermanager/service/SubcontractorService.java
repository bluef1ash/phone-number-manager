...
public interface SubcontractorService extends BaseService<Subcontractor> {
     ...
     * @return 社区分包人对象集合与分页对象
     */
    List<Subcontractor> get(UserLevelEnum userLevel, Serializable companyId, Serializable systemCompanyType, Serializable communityCompanyType, Serializable subdistrictCompanyType);
