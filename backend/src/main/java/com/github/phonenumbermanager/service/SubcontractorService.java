...
public interface SubcontractorService extends BaseService<Subcontractor> {
     ...
     */
    IPage<Subcontractor> get(Integer pageNumber, Integer pageDataSize, UserLevelEnum userLevel, Serializable companyId,
        Serializable systemCompanyType, Serializable communityCompanyType, Serializable subdistrictCompanyType);

    /**
     * 通过系统用户角色编号与系统用户角色定位编号
     *
     * @param userLevel
     *            系统用户单位类型
     * @param companyId
     ...
     * @return 社区分包人对象集合与分页对象
     */
    List<Subcontractor> get(UserLevelEnum userLevel, Serializable companyId, Serializable systemCompanyType,
     ...
     * @return 社区分包人对象集合
     */
    List<Subcontractor> getCorrelation(Serializable companyType, Serializable companyId, Serializable systemCompanyType,
        Serializable communityCompanyType, Serializable subdistrictCompanyType);
