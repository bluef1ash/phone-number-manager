...
(`id`, `name`, description, `uri`, `parent_id`, `icon_name`, `orders`, `is_display`, `create_time`, `update_time`)
VALUES (1, '首页相关', 'indexController', '', 0, '', 0, 0, '1000-01-01 00:00:00', '1000-01-01 00:00:00'),
    (1, '社区居民相关', 'communityResidentTitle', '', 0, '', 0, 1, '1000-01-01 00:00:00', '1000-01-01 00:00:00'),
    ...
    (5, '社区居民管理', 'communityResidentController', '', 1, 'fa fa-phone', 0, 1, '1000-01-01 00:00:00',
     '1000-01-01 00:00:00'),
    (6, '社区楼长管理', 'dormitoryManagerController', '', 1, 'fa fa-university', 0, 1, '1000-01-01 00:00:00',
     '1000-01-01 00:00:00'),
    (7, '社区管理', 'communityController', '', 2, 'fa fa-building', 0, 1, '1000-01-01 00:00:00', '1000-01-01 00:00:00'),
    (8, '街道管理', 'subdistrictController', '', 3, 'fa fa-laptop', 0, 1, '1000-01-01 00:00:00', '1000-01-01 00:00:00'),
    (9, '用户和角色管理', 'userAndRoleController', '', 4, 'fa fa-user', 0, 1, '1000-01-01 00:00:00', '1000-01-01 00:00:00'),
    (10, '系统管理', 'systemController', '', 4, 'fa fa-cog', 0, 1, '1000-01-01 00:00:00', '1000-01-01 00:00:00'),
    (11, '获取首页菜单栏内容', 'getMenu', '/getmenu', 1, 'fa fa-list', 0, 0, '1000-01-01 00:00:00', '1000-01-01 00:00:00'),
    (11, '获取图表数据', 'getComputedCount', '/getcomputed', 1, 'fa fa-list', 0, 0, '1000-01-01 00:00:00',
     '1000-01-01 00:00:00'),
    ...
    (48, '添加系统用户', 'createSystemUser', '/system/user_role/user/create', 9, 'fa fa-plus', 0, 0, '1000-01-01 00:00:00',
     '1000-01-01 00:00:00'),
    (49, '修改系统用户', 'editSystemUser', '/system/user_role/user/edit', 9, 'fa fa-pencil-square-o', 0, 0,
     '1000-01-01 00:00:00',
     '1000-01-01 00:00:00'),
    ...
    (53, '系统用户角色列表', 'systemUserRoleList', '/system/user_role/role', 9, 'fa fa-list', 0, 1, '1000-01-01 00:00:00',
     '1000-01-01 00:00:00'),
    (54, '添加系统用户角色', 'createSystemUserRole', '/system/user_role/role/create', 9, 'fa fa-plus', 0, 0,
     '1000-01-01 00:00:00',
     '1000-01-01 00:00:00'),
...
(`id`, `username`, `password`, `login_time`, `credential_expire_time`, `account_expire_time`, `create_time`,
 `update_time`)
VALUES (1, 'admin', '$2a$10$/TpNdGU4lVFrc.K3TrlM3.tiVyAkadJ1zNyWF9d34wLWgnaEziARG', '1000-01-01 00:00:00',
        '9999-12-31 23:59:59', '9999-12-31 23:59:59', '1000-01-01 00:00:00', '1000-01-01 00:00:00');
-- 添加系统用户与角色中间关系
INSERT INTO `phone_number`.`pm_user_role`
    (`user_id`, `role_id`, `create_time`, `update_time`)
VALUES (1, 1, '1000-01-01 00:00:00', '1000-01-01 00:00:00');
-- 添加系统配置
