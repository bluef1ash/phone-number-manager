...
VALUES (1, '首页相关', 'indexController', '', '', 0, 0, 1, '1000-01-01 00:00:00', '1000-01-01 00:00:00'),
    ...
    (9, '社区居民信息列表', 'communityResidentList', '/resident', '["GET"]', 2, 2, 0, '1000-01-01 00:00:00',
     '1000-01-01 00:00:00'),
    (10, '社区居民信息列表', './resident', '/resident', '["GET"]', 2, 1, 1, '1000-01-01 00:00:00', '1000-01-01 00:00:00'),
    (11, '通过编号查找社区居民信息', 'getCommunityResidentById', '/resident/{id}', '["GET"]', 2, 2, 0, '1000-01-01 00:00:00',
     '1000-01-01 00:00:00'),
    ...
    (20, '社区居民楼片长信息列表', 'dormitoryManagerList', '/dormitory', '["GET"]', 3, 2, 0, '1000-01-01 00:00:00',
     '1000-01-01 00:00:00'),
    (21, '通过编号查找社区居民楼片长信息', 'getDormitoryManagerById', '/dormitory/{id}', '["GET"]', 3, 2, 0, '1000-01-01 00:00:00',
     '1000-01-01 00:00:00'),
    ...
    (28, '社区居民楼片长增删改批量操作', 'dormitoryManagerBatch', '/dormitory/batch', '["POST"]', 3, 2, 0,
     '1000-01-01 00:00:00', '1000-01-01 00:00:00'),
    (29, '社区居民楼片长信息基础数据', 'dormitoryManagerBaseMessage', '/dormitory/computed/message', '["POST"]', 3, 2, 0,
     '1000-01-01 00:00:00', '1000-01-01 00:00:00'),
