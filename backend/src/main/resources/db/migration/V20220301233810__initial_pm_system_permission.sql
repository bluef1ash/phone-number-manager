...
VALUES (1, '首页相关', 'indexController', '', '', 0, 0, 1, '1000-01-01 00:00:00', '1000-01-01 00:00:00'),
    ...
    (57, '删除系统用户', 'removeSystemUser', '/system/user', '["DELETE"]', 5, 2, 0, '1000-01-01 00:00:00',
     '1000-01-01 00:00:00'),
    (58, '通过单位编号加载系统用户', 'loadSystemUserByCompanyId', '/system/user/company/{companyId}', '["GET"]', 5, 2,
     0,
     '1000-01-01 00:00:00', '1000-01-01 00:00:00'),
    (59, '增删改批量操作系统用户', 'systemUserBatch', '/system/user/batch', '["POST"]', 5, 2, 0, '1000-01-01 00:00:00',
     '1000-01-01 00:00:00'),
    (60, '系统用户表单列表', 'systemUserSelectList', '/system/user/select-list', '["GET"]', 5, 2, 0,
     '1000-01-01 00:00:00',
     '1000-01-01 00:00:00'),
    (61, '获取当前登录用户信息', 'currentSystemUser', '/system/user/current', '["GET"]', 5, 2, 0, '1000-01-01 00:00:00',
     '1000-01-01 00:00:00'),
    ...
    (67, '删除系统权限', 'removeSystemPermission', '/system/permission', '["DELETE"]', 5, 2, 0, '1000-01-01 00:00:00',
     '1000-01-01 00:00:00'),
    (68, '获取系统用户单位拥有的权限', 'getPermissionsByCompanyId', '/system/permission/company/{companyId}', '["GET"]',
     5, 2, 0,
     '1000-01-01 00:00:00', '1000-01-01 00:00:00'),
    ...
    (75, '修改处理系统配置', 'configurationModifyHandle', '/system/configuration/{id}', '["PUT"]', 6, 2, 0,
     '1000-01-01 00:00:00', '1000-01-01 00:00:00'),
    (76, '删除系统配置', 'removeConfigurationById', '/system/configuration', '["DELETE"]', 6, 2, 0,
     '1000-01-01 00:00:00',
     '1000-01-01 00:00:00'),
