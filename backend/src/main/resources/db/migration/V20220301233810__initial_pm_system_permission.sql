...
VALUES (1, '首页相关', 'indexController', '', '', 0, 0, 1, '1000-01-01 00:00:00', '1000-01-01 00:00:00'),
    ...
    (3, '社区楼长管理', 'dormitoryManagerController', '', '', 0, 0, 1, '1000-01-01 00:00:00', '1000-01-01 00:00:00'),
    ...
    (9, '居民电话列表', 'communityResidentList', '/resident', '["GET"]', 2, 2, 0, '1000-01-01 00:00:00',
     '1000-01-01 00:00:00'),
    (10, '居民电话列表', './resident', '/resident', '["GET"]', 2, 1, 1, '1000-01-01 00:00:00', '1000-01-01 00:00:00'),
    (11, '通过编号查找社区居民', 'getCommunityResidentById', '/resident/{id}', '["GET"]', 2, 2, 0, '1000-01-01 00:00:00',
     '1000-01-01 00:00:00'),
    (12, '添加居民信息处理', 'communityResidentCreateHandle', '/resident', '["POST"]', 2, 2, 0, '1000-01-01 00:00:00',
     '1000-01-01 00:00:00'),
    (13, '修改居民信息处理', 'communityResidentModifyHandle', '/resident/{id}', '["PUT"]', 2, 2, 0, '1000-01-01 00:00:00',
     '1000-01-01 00:00:00'),
    (14, '删除居民信息', 'removeCommunityResident', '/resident/{id}', '["DELETE"]', 2, 2, 0, '1000-01-01 00:00:00',
     '1000-01-01 00:00:00'),
    (15, '导入居民信息进系统', 'communityResidentImportAsSystem', '/resident/import/{streetId}', '["POST"]', 2, 2, 0,
     '1000-01-01 00:00:00', '1000-01-01 00:00:00'),
    (16, '导出居民信息到Excel', 'communityResidentSaveAsExcel', '/resident/download', '["GET"]', 2, 2, 0,
     '1000-01-01 00:00:00', '1000-01-01 00:00:00'),
    ...
    (19, '社区居民图表', 'communityResidentChart', '/resident/computed/chart', '["POST"]', 2, 2, 0,
     '1000-01-01 00:00:00', '1000-01-01 00:00:00'),
    (20, '楼长信息列表', 'dormitoryManagerList', '/dormitory', '["GET"]', 3, 2, 0, '1000-01-01 00:00:00',
     '1000-01-01 00:00:00'),
    (21, '通过编号查找社区楼长', 'getDormitoryManagerById', '/dormitory/{id}', '["GET"]', 3, 2, 0, '1000-01-01 00:00:00',
     '1000-01-01 00:00:00'),
    (22, '楼长信息列表', './dormitory', '/dormitory', '["GET"]', 3, 1, 1, '1000-01-01 00:00:00', '1000-01-01 00:00:00'),
    (23, '添加楼长信息处理', 'dormitoryManagerCreateHandle', '/dormitory', '["POST"]', 3, 2, 0, '1000-01-01 00:00:00',
     '1000-01-01 00:00:00'),
    (24, '修改楼长信息处理', 'dormitoryManagerModifyHandle', '/dormitory/{id}', '["PUT"]', 3, 2, 0, '1000-01-01 00:00:00',
     '1000-01-01 00:00:00'),
    (25, '删除楼长信息', 'removeDormitoryManager', '/dormitory/{id}', '["DELETE"]', 3, 2, 0, '1000-01-01 00:00:00',
     '1000-01-01 00:00:00'),
    (26, '导入楼长信息进系统', 'dormitoryManagerImportAsSystem', '/dormitory/import/{streetId}', '["GET"]', 3, 2, 0,
     '1000-01-01 00:00:00', '1000-01-01 00:00:00'),
    (27, '导出楼长信息到Excel', 'dormitoryManagerSaveAsExcel', '/dormitory/download', '["GET"]', 3, 2, 0,
     '1000-01-01 00:00:00', '1000-01-01 00:00:00'),
