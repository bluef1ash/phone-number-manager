    ...
    new Vue({
        ...
        created () {
            ...
            $ajax(
                ...
                (data) => {
                    if (data.state === 1) {
                        ...
                        if (
                            this.systemUser.companyType ===
                            this.subdistrictCompanyType
                        ) {
            ...
            if (this.systemUser.companyType === this.systemCompanyType) {
                ...
                this.systemUser.companyType === this.subdistrictCompanyType
            ) {
                ...
                this.loadMessageAndChart(
                    0,
                    this.systemUser.companyId,
                    this.systemUser.companyType
                )
            } else if (
                this.systemUser.companyType === this.communityCompanyType
            ) {
                    ...
                    (data) => {
                        ...
                        if (data.state === 1) {
                            if (data.resident.baseMessage) {
                                this.addCount =
                                    data.resident.baseMessage.addCount
                                this.haveToCount =
                                    data.resident.baseMessage.haveToCount
                                this.remnantCount =
                                    (this.haveToCount - this.addCount) * 0.8
                                this.percentCount =
                                    (this.addCount / this.haveToCount) * 100
                            ...
                            if (data.resident.barChart) {
                                ...
                                this.barChartExtend.xAxis.data =
                                    data.resident.barChart.titleLabel
                                this.barChartExtend.series.label.normal.formatter = (
                                    formatterData
                                ) =>
                                    formatNumber(formatterData.value) +
                                    data.resident.barChart.formatter
                                this.barChartExtend.yAxis.axisLabel.formatter = (
                                    formatterData
                                ) =>
                                    formatNumber(formatterData) +
                                    data.resident.barChart.formatter
                            ...
                            if (data.subcontractor.barChart) {
                                ...
                                this.barChartSubcontractor =
                                    data.subcontractor.barChart.data
                                this.subcontractorBarChartExtend.xAxis.data =
                                    data.subcontractor.barChart.titleLabel
                                this.subcontractorBarChartExtend.series.label.normal.formatter = (
                                    formatterData
                                ) =>
                                    formatNumber(formatterData.value) +
                                    data.subcontractor.barChart.formatter
                                this.subcontractorBarChartExtend.yAxis.axisLabel.formatter = (
                                    formatterData
                                ) =>
                                    formatNumber(formatterData) +
                                    data.subcontractor.barChart.formatter
                            ...
                            if (data.dormitory.baseMessage) {
                                this.dormitoryGender =
                                    data.dormitory.baseMessage.gender
                                let genderCount =
                                    this.dormitoryGender.male +
                                    this.dormitoryGender.female
                                if (genderCount > 0) {
                                    this.dormitoryGender.maleParent = Math.ceil(
                                        (this.dormitoryGender.male /
                                            genderCount) *
                                        100
                                    )
                                    this.dormitoryGender.femaleParent =
                                        100 - this.dormitoryGender.maleParent
                                }
                                this.dormitoryAge =
                                    data.dormitory.baseMessage.age
                                this.dormitoryEducation =
                                    data.dormitory.baseMessage.education
                                this.dormitoryPoliticalStatus =
                                    data.dormitory.baseMessage.politicalStatus
                                this.dormitoryWorkStatus =
                                    data.dormitory.baseMessage.workStatus
                            ...
                            if (data.dormitory.barChart) {
                                ...
                                this.dormitoryBarChart =
                                    data.dormitory.barChart.data
                                this.dormitoryBarChartExtend.yAxis.formatter = (
                                    formatterData
                                ) =>
                                    formatNumber(formatterData) +
                                    data.dormitory.barChart.formatter
                                this.dormitoryBarChartExtend.series.label.normal.formatter = (
                                    formatterData
                                ) =>
                                    formatNumber(formatterData.value) +
                                    data.dormitory.barChart.formatter
                                this.dormitoryBarChartExtend.xAxis.data =
                                    data.dormitory.barChart.titleLabel
