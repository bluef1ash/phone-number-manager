...
export async function querySystemPermissionList(params?: any, options?: Record<string, any>) {
  return request<API.DataList<API.SystemPermission> & API.ErrorResponse>(system.permission, {
    method: 'GET',
    params,
    ...(options || {}),
  });
...
export async function querySystemPermissionSelectList(options?: Record<string, any>) {
  return request<API.Data<API.SelectList[]> & API.ErrorResponse>(system.permissionSelectList, {
    method: 'GET',
    ...(options || {}),
  });
}
...
export async function querySystemPermission(id: number, options?: Record<string, any>) {
  return request<API.Data<API.SystemPermission> & API.ErrorResponse>(`${system.permission}/${id}`, {
    method: 'GET',
    ...(options || {}),
  });
}
...
export async function createSystemPermission(
  ...
  return request<API.ResponseSuccess & API.ErrorResponse>(system.permission, {
    method: 'POST',
    data,
    ...(options || {}),
  });
...
export async function removeSystemPermission(id: number, options?: Record<string, any>) {
  return request<API.ResponseSuccess & API.ErrorResponse>(`${system.permission}/${id}`, {
    method: 'DELETE',
    ...(options || {}),
  });
}
...
export async function batchSystemPermission<T>(
  ...
  return request<API.ResponseSuccess & API.ErrorResponse>(system.permissionBatch, {
    method: 'POST',
    data,
    ...(options || {}),
  });
