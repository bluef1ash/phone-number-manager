 ...
 * @author 廿二月的天
 */
public interface DormitoryManagerDao extends BaseDao<DormitoryManager> {
     ...
     * @throws DataAccessException 数据库连接异常
     */
    Map<String, Long> countSexByCommunityId(Serializable communityId) throws DataAccessException;
     ...
     * @throws DataAccessException 数据库连接异常
     */
    Map<String, Long> countSexBySubdistrictId(Serializable subdistricId) throws DataAccessException;
