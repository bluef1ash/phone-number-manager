...
public class DormitoryManager implements Serializable {
    ...
    public DormitoryManager(String id, Long sequenceNumber, String name, Integer sex, String sexName, Date birth, String birthString, Integer age, Integer politicalStatus, String politicalStatusName, Integer workStatus, String workStatusName, Integer education, String educationName, String address, String managerAddress, Integer managerCount, String phones, Timestamp editTime, Long subcontractorId, Long communityId, String mobile, String landline, Timestamp createTime, Timestamp updateTime, Subcontractor subcontractor, String subcontractorName, String subcontractorTelephone, Community community, String communityName) {
        this.id = id;
    ...
    public String toString() {
        return "DormitoryManager{" + "id='" + id + '\'' + ", sequenceNumber=" + sequenceNumber + ", name='" + name + '\'' + ", sex=" + sex + ", sexName='" + sexName + '\'' + ", birth=" + birth + ", birthString='" + birthString + '\'' + ", age=" + age + ", politicalStatus=" + politicalStatus + ", politicalStatusName='" + politicalStatusName + '\'' + ", workStatus=" + workStatus + ", workStatusName='" + workStatusName + '\'' + ", education=" + education + ", educationName='" + educationName + '\'' + ", address='" + address + '\'' + ", managerAddress='" + managerAddress + '\'' + ", managerCount=" + managerCount + ", phones='" + phones + '\'' + ", createTime=" + createTime + ", updateTime=" + updateTime + ", subcontractorId=" + subcontractorId + ", communityId=" + communityId + ", mobile='" + mobile + '\'' + ", landline='" + landline + '\'' + ", subcontractor=" + subcontractor + ", subcontractorName='" + subcontractorName + '\'' + ", subcontractorTelephone='" + subcontractorTelephone + '\'' + ", community=" + community + ", communityName='" + communityName + '\'' + '}';
    }
}
