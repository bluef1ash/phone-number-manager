...
public interface CommunityService extends BaseService<Community> {
     ...
     * @return 是否更改成功
     */
    boolean update(List<Map<String, Object>> data, Integer changeType, Serializable communityCompanyType, Serializable subdistrictCompanyType);
