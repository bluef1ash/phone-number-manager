...
public class ExcelUtil {
     ...
     * @throws IOException 文件流异常/字符串转换异常
     */
    public static void downloadExcelFile(HttpServletResponse response, HttpServletRequest request, String title, ByteArrayOutputStream byteArrayOutputStream) throws IOException {
