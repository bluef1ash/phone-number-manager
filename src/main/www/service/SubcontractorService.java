...
public interface SubcontractorService extends BaseService<Subcontractor> {
     ...
     * @param systemRoleId      系统级角色编号
     * @return 社区分包人对象集合与分页对象
     * @throws Exception Service异常
     */
    Map<String, Object> findSubcontractors(Integer pageNumber, Integer pageDataSize, Long roleId, Long roleLocationId, Long communityRoleId, Long subdistrictRoleId, Long systemRoleId) throws Exception;
