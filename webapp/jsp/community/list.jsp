...
<%@ include file="/jsp/layouts/header.jsp" %>
	...
	<body>
		...
		<a href="${pageContext.request.contextPath}/community/create.action" class="btn btn-primary float-right margin-br-10 menu-tab" role="button" ondragstart="return false;">添加社区</a>
			...
			<tbody>
				<c:forEach items="${communities}" var="community" varStatus="status">
					<tr>
						...
						<td>
							<a href="${pageContext.request.contextPath}/community/edit.action?id=${community.communityId}" class="btn btn-default btn-sm operation" role="button" ondragstart="return false;">修改</a>
							<a href="javascript:;" class="btn btn-danger btn-sm operation" role="button" onclick="commonFunction.deleteObject('${pageContext.request.contextPath}/community/ajax_delete.action', ${community.communityId}, '${_token}');" ondragstart="return false;">删除</a>
						</td>
					</tr>
				</c:forEach>
			</tbody>
