...
<%@ include file="/jsp/layouts/header.jsp" %>
	...
	<body>
        <div class="container top">
            <div class="row">
                <h2 class="col-md-5 error-code">400</h2>
                <div class="col-md-7 error-message">
                    <h3>抱歉，出现错误了！</h3>
                    <div class="text">
                        无法访问本页面的原因是：<br>
                        ${exception.message}<br>
                        您可以<a href="javascript:history.go(-1);" title="返回" ondragstart="return false;">返回</a>上一页，或者再次<a href="javascript:location.reload();" title="刷新" ondragstart="return false;">刷新</a>本页面！<br>
