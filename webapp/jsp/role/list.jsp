...
<%@ include file="/jsp/layouts/header.jsp" %>
	...
	<body>
		...
		<a href="${pageContext.request.contextPath}/system/user_role/role/create.action" class="btn btn-default float-right margin-br-10 menu-tab" role="button" title="添加角色" ondragstart="return false;">添加角色</a>
			...
			<tbody>
				...
				<c:forEach items="${userRoles}" var="role" varStatus="status">
					<tr>
						...
						<td>预留</td>
						<td>
							<a href="${pageContext.request.contextPath}/system/user_role/role/edit.action?id=${role.roleId}" class="btn btn-default operation" role="button" title="修改" ondragstart="return false;">修改</a>
                            <a href="javascript:;" class="btn btn-default operation delete-resident" onclick="commonFunction.deleteObject('${pageContext.request.contextPath}/system/user_role/role/ajax_delete.action', ${role.roleId}, '${_token}')" role="button" title="删除" ondragstart="return false;">删除</a>
						</td>
					</tr>
				</c:forEach>
			</tbody>
